...
const styles = {
  ...
  intCard:   { display:'flex', alignItems:'center', gap:10, padding:'14px 16px', borderRadius:10, border:'2px solid transparent', transition:'all 0.15s', background:'#F8FAFC', minWidth:0 },
  ...
  intName:   { fontSize:14, fontWeight:600, color:N, whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis' },
  ...
  connectBtn:  { padding:'6px 10px', background:B, color:'#fff', border:'none', borderRadius:8, fontSize:11, fontWeight:600, cursor:'pointer', flexShrink:0 },
