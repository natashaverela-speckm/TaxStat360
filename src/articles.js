...
// ââ Live tax-figure bindings (AF-02 follow-up / centralization) âââââââââââââââ
...
// automatically â there is no second place to update.
//
// Bound here: Social Security wage base, Â§199A phase-in thresholds, the Â§199A
// SSTB / wage-limit phase-out ceilings (threshold + phase-in range), and the
// Â§199A $400 minimum deduction.
//
...
// (OBBBA Â§70101), so adding 2027+ keys to QBI_MIN_DEDUCTION will roll this prose
// forward automatically once the article's worked-year is advanced.
//
// NOT bound by design: the Â§6654 estimated-tax penalty rate. It resets quarterly
...
export const ARTICLES = [
  {
    ...
    metaDescription:
      'Learn how S-Corp owners can legally reduce self-employment tax by splitting pay between officer salary and K-1 distributions â with real numbers, IRS rules, and what triggers audits.',
    ...
    sections: [
      {
        ...
        body: `For S-Corporation owners, how you pay yourself is one of the most consequential tax decisions you make each year. Every dollar you pay yourself as a W-2 salary is subject to FICA taxes â 15.3% total, split evenly between employer and employee: 12.4% for Social Security on the first ${usd(_ssWageBase2026)} (2026), plus 2.9% for Medicare on all wages with no cap (and an additional 0.9% above $200,000). Every dollar you take as a K-1 distribution is not subject to FICA.

On $200,000 of S-Corp profit, the difference between paying yourself $50,000 in salary versus $100,000 in salary is roughly $7,650 in FICA taxes â the same amount a W-2 employee pays in a year just on Social Security and Medicare.

The IRS knows this. They have been scrutinizing S-Corp salary practices since at least Rev. Rul. 74-44, which established that amounts paid to shareholder-employees must represent reasonable compensation for services rendered. The strategy is legal â but only when the salary is genuinely reasonable.`,
      },
      {
        heading: 'The IRS Reasonable Compensation Requirement',
        body: `IRC Â§3121(d) defines who is an employee subject to FICA, and S-Corp shareholder-employees fall squarely within it. The IRS's position, codified in Rev. Rul. 74-44, is that an S-Corp cannot reclassify wages as distributions to avoid employment taxes.

The landmark case is David E. Watson, P.C. v. United States, 668 F.3d 1008 (8th Cir. 2012), where the courts upheld the reclassification of a CPA's $24,000 salary â set against more than $200,000 of annual distributions from his firm â to reasonable compensation of $91,044 per year, with the additional wages subject to back FICA plus penalties and interest. The message was clear: the IRS will look through artificially low salaries.
...
Reasonable compensation is the amount a comparable employee would receive for the same services in an arm's-length transaction. Factors the IRS considers include your industry, hours worked, the company's gross receipts, your training and experience, and what similar businesses pay for comparable roles.`,
      ...
      {
        heading: 'The 35/65 Rule of Thumb â and Its Limits',
        body: `Many CPAs use a 35/65 or 40/60 split as a starting benchmark: pay yourself 35â40% of total officer compensation (salary + distributions) as salary, and take the rest as distributions. This is not an IRS rule â it's a practitioner heuristic that has survived scrutiny when supported by documentation.
...
Scenario A â $70,000 salary, $230,000 distributions:
Employee FICA: $70,000 Ã 7.65% = $5,355
Employer FICA: $70,000 Ã 7.65% = $5,355 (deductible)
Total FICA cost: ~$10,710

Scenario B â $150,000 salary, $150,000 distributions:
Employee FICA on SS portion: $150,000 Ã 6.2% = $9,300 (the entire $150,000 salary is below the 2026 Social Security wage base of ${usd(_ssWageBase2026)}, so all of it is subject to the 6.2% Social Security tax)
Employee FICA on Medicare: $150,000 Ã 1.45% = $2,175
Total employee: $11,475 | Employer match: $11,475
Total FICA cost: ~$22,950

The difference is $12,240 in FICA taxes â real cash savings, achieved through a fully legal structure, simply by setting the right salary level.
...
The S-Corp structure itself doesn't create the savings. The savings come from having any net profit beyond your salary. If your salary equals your profit, the S-Corp provides no FICA advantage over a sole proprietorship.`,
      },
      {
        ...
        body: `The IRS flags S-Corps with zero officer compensation or compensation dramatically below the S-Corp's gross receipts. The IRS's published guidance â its "S Corporation Compensation and Medical Insurance Issues" page and Fact Sheet FS-2008-25 ("Wage Compensation for S Corporation Officers") â directs that shareholder-employees who perform services be paid reasonable compensation before taking distributions, and identifies the factors weighed in that determination, such as training and experience, duties and responsibilities, time and effort devoted to the business, and what comparable businesses pay for similar services.
...
TaxStat360 flags when your officer salary falls below about 40% of total compensation â within the 35â45% range tax practitioners commonly cite â and displays the relevant case citations inline. That range is a screening heuristic, not an IRS rule: there is no published safe-harbor percentage, and reasonable compensation is always a facts-and-circumstances determination. The tax savings estimate updates in real time as you adjust the salary field, so you can find a defensible figure and see exactly what the FICA savings look like at that salary level.`,
...

  {
    ...
    title: 'The Â§199A QBI Deduction for LLC and S-Corp Owners: A Plain-English Guide',
    metaDescription:
      'The Â§199A QBI deduction lets pass-through business owners deduct up to 20% of qualified business income. Here\'s what it is, who qualifies, what limits apply, and how to maximize it.',
    category: 'Tax Deductions',
    readMinutes: 9,
    publishedDate: '2026-04-15',
    heroIcon: 'chartDown',
    tags: ['QBI', 'Â§199A', 'S-Corp', 'LLC', 'SSTB'],
    sections: [
      {
        heading: 'What the Â§199A Deduction Is',
        body: `The Tax Cuts and Jobs Act of 2017 created IRC Â§199A, which allows eligible taxpayers to deduct up to 20% of their Qualified Business Income (QBI) from a pass-through entity â an S-Corporation, partnership, LLC, or sole proprietorship. The One Big Beautiful Bill Act of 2025 (P.L. 119-21) made this deduction permanent and added a ${usd(_qbiMin2026)} minimum deduction for 2026 onward.

For an S-Corp owner with $200,000 of QBI taxed at the 24% marginal rate, a full QBI deduction is worth $200,000 Ã 20% Ã 24% = $9,600 in federal income tax savings. For a taxpayer in the 32% bracket, the same deduction saves $12,800.
...
What reduces QBI: Section 179 deductions passed through from the entity (Treas. Reg. Â§1.199A-3(b)(1)(ii)(A)), charitable contributions from the entity, and prior-year QBI losses. What does NOT count as QBI: capital gains, interest income, dividends, foreign income, and most importantly â the W-2 salary you pay yourself as an S-Corp officer.

This last point is critical. If your S-Corp generates $300,000 of gross profit and you pay yourself a $70,000 officer salary, your K-1 ordinary income (and QBI basis) is $230,000 â not $300,000. The salary was already deducted at the entity level before the K-1 was issued.`,
      },
      {
        heading: 'The W-2 Wage and UBIA Limitation',
        body: `Above certain income thresholds, the Â§199A deduction is limited by either (a) 50% of W-2 wages paid by the business, or (b) 25% of W-2 wages plus 2.5% of the unadjusted basis in qualified property (UBIA).
...
Example: Your S-Corp has $400,000 of QBI and pays $120,000 in W-2 wages (including your salary). The 50% W-2 limitation = $60,000. If your tentative QBI deduction is $80,000 (20% of $400K), it is capped at $60,000 â a $20,000 reduction. The fix: pay higher officer wages, which both increases the W-2 wage limitation and (for an S-Corp) reduces distributions but maintains the FICA advantage.`,
      },
      {
        heading: 'Specified Service Trades or Businesses (SSTB)',
        body: `If your business falls into the SSTB category â which includes law, health, consulting, financial services, accounting, and performing arts â the QBI deduction phases out entirely for taxpayers above the income ceiling.

Above ${usd(_qbiCeil2026.single)} (Single) / ${usd(_qbiCeil2026.mfj)} (MFJ) of taxable income in 2026, an SSTB owner's QBI deduction is $0, regardless of W-2 wages or UBIA. The phase-out is a cliff â not a gradual reduction once the ceiling is crossed.

Businesses that are NOT SSTB: engineering, architecture, retail, real estate (rental), manufacturing, and most trades. Mixed businesses â where less than 10% of gross receipts come from SSTB services â may qualify for an allocation of the non-SSTB portion. The regulations are detailed; if your business is on the line, a CPA review of your revenue mix is worth doing before year-end.`,
      },
      {
...
Second, W-2 wage optimization: for taxpayers above the phase-in threshold, paying more in wages increases the W-2 wage limitation. The calculus: paying $10,000 more in wages costs roughly $1,530 in FICA (employee + employer) but increases the limitation by $5,000 (50% of $10K) â worthwhile if the QBI deduction was previously capped below $5,000 of the tentative deduction.

Third, entity structuring: a C-Corp generates no QBI and cannot pass through the Â§199A deduction. S-Corps, partnerships, and sole props do. If you are considering converting entity type, the Â§199A treatment is a meaningful factor.`,
      },
      {
        heading: 'How TaxStat360 Handles the QBI Calculation',
        body: `TaxStat360 computes the Â§199A deduction using the 2026 thresholds updated for P.L. 119-21 and applies all three limitation rules simultaneously: the SSTB phase-out, the W-2/UBIA wage limitation, and the taxable income ceiling. The deduction is shown as a separate line in the Tax Waterfall so you can see exactly what it's worth in the context of your full income picture.

The Â§199A ${usd(_qbiMin2026)} minimum deduction (new for 2026) is also applied: if the calculated deduction would be less than ${usd(_qbiMin2026)}, TaxStat360 uses ${usd(_qbiMin2026)} as the floor. Enter your K-1 Â§199A statement amounts â W-2 wages and UBIA (Box 17 Code V) â and the SSTB checkbox to see the full computation.`,
      },
    ],
...

  {
    ...
    heroIcon: 'calendar',
    tags: ['Estimated Taxes', 'Form 1040-ES', 'Safe Harbor', 'Â§6654'],
    sections: [
      {
        heading: 'Why Business Owners Pay Quarterly',
        body: `W-2 employees have taxes withheld from every paycheck. Business owners â S-Corp shareholders, partners, and sole proprietors â generally do not. The IRS expects taxes on business income to be paid throughout the year, not in a lump sum on April 15.

IRC Â§6654 imposes an underpayment penalty when a taxpayer does not pay enough tax through withholding and estimated payments during the year. The penalty is calculated as the federal short-term rate plus 3 percentage points, applied to the underpaid amount for the period of underpayment. Because the IRS resets that rate every quarter to track prevailing interest rates, the exact figure shifts through the year â it has run in the mid-to-high single digits in recent years â but the penalty is entirely avoidable.
...
The four standard due dates: April 15 (Q1), June 15 (Q2), September 15 (Q3), and January 15 of the following year (Q4). Missing a due date means the underpayment penalty accrues from that date forward, even if you pay in full by the next quarter.`,
      },
      {
        ...
        body: `You avoid the Â§6654 penalty entirely if your total withholding and estimated payments meet either of two safe harbors.

Safe Harbor 1 â 90% of current-year tax: Pay at least 90% of your actual tax liability for the current year, spread across the four quarters. This method requires you to estimate your income accurately throughout the year.

Safe Harbor 2 â 100% (or 110%) of prior-year tax: Pay an amount equal to last year's total tax (Form 1040, Line 24). If your prior-year AGI exceeded $150,000 ($75,000 if married filing separately), the threshold rises to 110% of prior-year tax. This is the most common method for business owners because it requires no current-year estimation â you know exactly what last year's tax was.
...
Safe harbor total = $32,000 Ã 110% = $35,200
Per-quarter payment = $35,200 Ã· 4 = $8,800
...
This is a planning opportunity: if you know a large Q4 distribution is coming and you haven't made estimated payments, increasing the withholding on your final W-2 paycheck can cover the shortfall. The withholding appears on line 25 of Form 1040 and is treated as evenly distributed. Note: this only works for W-2 withholding, not for estimated tax vouchers.`,
      },
      {
        ...
        body: `Estimated taxes are paid online via EFTPS (Electronic Federal Tax Payment System) using Form 1040-ES vouchers as reference. Payments can also be made through Direct Pay on IRS.gov. Keep records of each payment date and amount â in an audit or penalty dispute, the exact dates matter.
    ...
    sections: [
      {
        ...
        body: `IRC Â§3121(d)(1) classifies corporate officers as employees subject to FICA taxes. For an S-Corporation, this means any shareholder who performs services â however minimal â must receive a reasonable salary before taking distributions. This rule is not optional and not negotiable.
...
Glass Blocks Unlimited v. Commissioner, T.C. Memo. 2013-180 similarly recharacterized the sole shareholder-officer's distributions as wages â over $30,000 for each of 2007 and 2008 â even though the company's net income was far lower, adding employment taxes and penalties.`,
      },
      {
...
Voluntary correction is generally preferable to waiting for an IRS examination. The IRS's Voluntary Correction Program (VCP) under EPCRS does not cover payroll tax issues, but proactively amending prior Forms 941 and paying the back taxes â before an audit is opened â typically results in interest but avoids the full suite of penalties available to examiners.
...
Review it annually. As the business grows, so should the salary â or you should document why it did not. An S-Corp where revenue doubled but officer compensation held flat requires a written explanation of why that outcome is still arm's-length (perhaps because the company retained earnings for expansion, and a third-party employee would not have received the full benefit of that growth).

TaxStat360 flags when officer salary falls below about 40% of total compensation â within the 35â45% range practitioners commonly cite â and surfaces the relevant IRS citations. The percentage is a screening heuristic, not a safe harbor: the final determination always depends on your specific facts and the industry data you document.`,
      },
    ],
...

  {
    ...
    metaDescription:
      'IRC Â§469 limits when you can deduct rental losses. Learn the $25,000 allowance, Real Estate Professional status, passive loss carryforwards, and how to maximize your deductions legally.',
    category: 'Real Estate',
    readMinutes: 9,
    publishedDate: '2026-05-01',
    heroIcon: 'home',
    tags: ['Passive Activity', 'Â§469', 'Real Estate', 'REP Status', 'Form 8582'],
    sections: [
      {
        heading: 'The Basic Rule: Passive Losses Can Only Offset Passive Income',
        body: `IRC Â§469, enacted by the Tax Reform Act of 1986, fundamentally changed real estate investing by restricting when losses from rental activities can be deducted. The basic rule: passive activity losses can only offset passive activity income. They cannot offset wages, business income, or portfolio income (dividends and interest).
...
Suspended losses accumulate on Form 8582 (Passive Activity Loss Limitations). When you sell the property, all suspended losses from that property are released and deductible in the year of sale.`,
      },
      {
        ...
        body: `IRC Â§469(i) creates a limited exception for "active participants" in rental real estate. If you actively participated â meaning you made management decisions about the property in a bona fide sense (approving tenants, setting rents, authorizing repairs) â you can deduct up to $25,000 of rental losses against non-passive income.

The $25,000 allowance phases out at 50 cents per dollar of AGI above $100,000, reaching zero at $150,000 AGI. At $125,000 AGI, for example, the allowance is: $25,000 â (($125,000 â $100,000) Ã 0.50) = $12,500. At $150,000 and above, no allowance is available.
...
Active participation is a lower bar than material participation â you do not need to spend 500 hours managing the property. But you cannot be a completely passive investor (for example, owning through a limited partnership where a general partner manages everything) and still claim active participation.`,
      },
      {
        heading: 'Real Estate Professional Status: Unlimited Deductions',
        body: `IRC Â§469(c)(7) creates a far more powerful exception: Real Estate Professional (REP) status. If you qualify, your rental activities are reclassified from passive to non-passive, and rental losses can offset any income â wages, business income, anything.
...
The second test is the killer for most W-2 employees. If you work a 40-hour-per-week job, you spend approximately 2,080 hours annually at that job. To pass the 50% test, you would need to spend more time in real estate than at your job â essentially making real estate your primary occupation. Spending 800 hours on real estate while working 2,080 hours at a W-2 job fails the 50% test even though it clears the 750-hour hurdle.
...
Contemporaneous means recorded at or near the time the activity occurred â not reconstructed from memory when you receive an audit notice. A simple spreadsheet or calendar entry noting date, property, activity, and hours is sufficient. It does not need to be elaborate, but it must be consistent.
...
Qualifying real estate activities include: real property development, construction, acquisition, conversion, rental, operation, management, leasing, and brokerage. Time spent as a passive investor (reviewing statements, attending investor meetings) does not count. Time commuting to properties generally does not count unless travel itself is the business activity.`,
      },
      {
        ...
        body: `Every year that your rental losses exceed allowable deductions, the excess is suspended and carried forward â indefinitely. For a high-income investor above the $150,000 AGI threshold with no passive income and no REP status, 100% of rental losses accumulate on Form 8582.

These carryforwards are not lost. They represent a future tax asset with several release mechanisms:

1. Disposition: When you sell the property in a taxable transaction, all suspended losses attributable to that property are released in the year of sale. A property with $80,000 of accumulated suspended losses, sold this year, generates an $80,000 deduction in the year of sale â which can reduce taxable gain significantly.
...
3. REP qualification: Qualifying as a Real Estate Professional makes the activity non-passive going forward. Note that this does not by itself release prior suspended losses against all income â under Â§469(f), those "former passive activity" losses can offset income from that same activity (or other passive income) and are fully freed only on a qualifying disposition.

Tracking your suspended losses by property on Form 8582 is essential. Many investors don't realize the magnitude of their carryforward until they sell â and then are surprised that their tax bill is lower than expected because of deductions they couldn't use years earlier.`,
      },
      {
        heading: 'Planning Around Â§469',
        body: `Several strategies work within Â§469 to maximize deductible losses. First, passive income grouping: Â§469 allows taxpayers to group multiple rental properties as a single activity for material participation and passive income purposes. Grouping profitable and loss rentals can make the combined activity passive-income-positive, releasing losses from the profitable properties.

Second, real estate syndications: limited partnership interests in real estate funds generate passive income that can absorb suspended losses from your direct rental properties. This is why some high-income investors in real estate funds â who cannot use the losses from the fund directly â can pair them with passive income from their own properties.

Third, short-term rentals: rentals where the average customer stay is 7 days or less are not subject to Â§469's passive presumption â they're treated like a business. If you materially participate (which requires meeting one of seven IRS tests, typically 500+ hours or more than any other person), losses are active and deductible against any income. This is the tax treatment behind many high-income investors' interest in vacation rental platforms.

TaxStat360 models the Â§469(i) phase-out and REP status in real time. Enter your AGI, rental income, and expenses, and check the appropriate box â the tool shows exactly how much of the loss is deductible under the special allowance, how much is suspended, and how REP status changes the picture.`,
      },
    ],
