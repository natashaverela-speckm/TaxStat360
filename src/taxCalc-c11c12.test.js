...
describe('C-11 Finding 1 — §1368 distributions applied before §1366 losses', () => {
  it('(a) distribution < pre-loss basis → no §1368 gain, larger suspended loss', () => {
  ...
  it('(b) distribution > pre-loss basis → §1368(b)(2) gain on the TRUE excess only', () => {
  ...
  it('(c) distribution with no loss → reduces basis, excess over basis+income is gain', () => {
...
describe('C-11 Finding 3 — Form 7203 Line 2 contributions create basis', () => {
  it('audit case: $264,020 current-year contributions fund the loss; no §1368 gain', () => {
    const r = run(sCorp({
  ...
  it('contributions alone (blank beginning basis) still count as a basis entry', () => {
  ...
  it('basis-increase income items (Lines 3a–3m) restore basis', () => {
...
describe('C-12 Finding 2 — §469(c)(7)(B) hours test gates the aggregation election', () => {
  ...
  it('hours omitted → unchanged behavior: election frees the loss (backward compatible)', () => {
    const r = rep()
  ...
  it('failing hours (800 of 3,000 = 27%) → election NOT operative, loss suspended', () => {
  ...
  it('failing hours + explicit override → election honored (at-risk position recorded)', () => {
  ...
  it('passing hours (2,000 of 3,000) → election operative', () => {
