...
const reg=await apiFetch('/auth/register',{method:'POST',credentials:'include',body:{name,email,password:pass,plan,billing,payment_method_id:setupIntent.payment_method},raw:true})
