      ...
      <section id="pricing" style={{ padding: '32px 24px', textAlign: 'center', background: '#fff' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 14, maxWidth: 960, margin: '0 auto' }}>
          {[
            ...
            { name:'Enterprise', price:'$299', highlight:false, desc:'Multi-entity management, CPA collaboration, and full audit defense.', features:['Everything in Professional plus:','What-If Scenario Simulator','Risk Tolerance Profiling','AI-Generated Audit Defense Narrative','CPA Collaboration Portal',] },
          ].map((p,i) => (
