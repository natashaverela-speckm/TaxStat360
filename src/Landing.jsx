        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 14, maxWidth: 1000, margin: '0 auto' }}>
          {[
            { icon: 'office', label: 'K-1',
              ...
              desc: 'Officer W-2 salary, K-1 income, and the SE-tax savings of the S-Corp structure versus a sole proprietorship, all calculated instantly. See exactly how your salary-to-distribution split affects your estimated federal tax liability.' },
...
{DISCLAIMER_SHORT}
        ...
        <p style={{ marginTop: 32, fontSize: 13, color: '#94a3b8' }}>7-day free trial on all plans &middot; No charge until trial ends &middot; Cancel anytime in Settings</p>
