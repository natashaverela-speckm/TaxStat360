...
Business Input - List All Entities    const totalK1 = entities.reduce((sum, entity) => 
                ...
                <div style={{
                    ...
                    position: 'sticky', top: 0, zIndex: 100
                        ...
                        <h1 style={{ fontSize: '24px', fontWeight: '800', color: '#0f172a', margin: 0 }}>
                                  Enhanced Business Input-List All Entities K-1 Calculator - Navy Blue Theme
                        </h1>h1>
                        <p style={{ color: '#64748b', fontSize: '14px', margin: '4px 0 0' }}>
                                  PRESERVED: QuickBooks, FreshBooks, Wave, Xero integration
                        </p>p>Business Input-List All Entities
                </div>div>
  ...
  return e('div',{style:{minHeight:'100vh',background:'#F8FAFC',fontFamily:'system-ui,sans-serif',color:N}},
             ...
             e('div',{style:{maxWidth:1100,margin:'0 auto',padding:'32px 20px'}},
                   e('div',{style:{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:28}},
                           e('div',null,
                                     e('h1',{style:{fontSize:26,fontWeight:800,color:N,margin:0}},'Enhanced Business Input-List All Entities K-1 Calculator'),
