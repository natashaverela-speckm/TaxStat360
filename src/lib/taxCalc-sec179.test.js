...
describe('getEntityPnlNet — the P&L derivation rule (single source)', () => {
  ...
  it('CHAR: stored netProfit wins over derivation', () => {
    expect(getEntityPnlNet({ pnl: { netProfit: '80000', grossRevenue: '300000', totalExpenses: '100000' } }))
      .toBe(80000)
  })

  it('CHAR: derives grossRevenue − totalExpenses when netProfit absent', () => {
    expect(getEntityPnlNet({ pnl: { grossRevenue: '300000', totalExpenses: '100000' } }))
      .toBe(200000)
  })

  it('CHAR: comma-formatted strings parse fully — nf(), not parseFloat', () => {
  ...
  it('CHAR: missing pnl → 0; does NOT read legacy e.netProfit', () => {
  ...
  it('CHAR: negative derived net (loss) flows through', () => {
...
describe('getEntityPnlNetShare — rounded ownership share', () => {
  ...
  it('CHAR: Math.round(net × own% / 100), identical to the inline pattern', () => {
    const e = { own: '50', pnl: { netProfit: '100001' } }
    expect(getEntityPnlNetShare(e)).toBe(50001)   // round(50000.5) = 50001
  })

  it('CHAR: missing ownership defaults to 100%; explicit 0% stays 0 (F-M02)', () => {
...
describe('sumK1FlowThrough — flow-through k1Total rule', () => {
  ...
  it('CHAR: sums owner shares net of §179, skipping C-Corps', () => {
  ...
  it('CHAR: charitable (box12_13) is NOT netted — Schedule A item (SPEC: audit F-13; §702(a)/§1366(a)(1)(A) separately-stated treatment)', () => {
  ...
  it('CHAR: null entities are skipped; empty/invalid input → 0 (CHAR + hardening)', () => {
...
describe('calc179Limitation — §179(b)(3) business-income limitation', () => {
  ...
  it('CHAR: §179 fully allowed when active business income covers it', () => {
  ...
  it('CHAR: §179 limited by low active business income; excess carries (SPEC: §179(b)(3)(A)–(B))', () => {
  ...
  it('CHAR: W-2 wages count toward the income limit (SPEC: §179(b)(3)(A); Treas. Reg. §1.179-2(c)(6)(iv) — employee wages are active-conduct income)', () => {
  ...
  it('CHAR: charitable add-back is a wash in k1Capped but raises the income proxy', () => {
  ...
  it('CHAR: zero active business income disallows all §179', () => {
  ...
  it('CHAR: null entities and empty input are safe (hardening — inline formula would have thrown)', () => {
...
describe('SPEC §179(b)(1)/(b)(2) — annual dollar limitation and phase-out', () => {
  ...
  it('CHAR: SPEC-179D-1 [Rev. Proc. 2025-32]: 2026 elected $3.0M, ample income → allowed $2,560,000; $440,000 disallowed', () => {
  ...
  it('CHAR: SPEC-179D-2 [§179(b)(2)]: 2026 elected $4.3M → reduction $210K → limit $2,350,000', () => {
  ...
  it('CHAR: SPEC-179D-3 [§179(b)(2)]: 2026 elected $6.65M → limit fully phased out to $0', () => {
  ...
  it('CHAR: SPEC-179D-4 [interaction]: below the cap the (b)(3) income limit still governs — elected $500K, pre-§179 income $400K → allowed $400K', () => {
  ...
  it('CHAR: SPEC-179D-5 [P.L. 119-21 §70306]: 2025 statutory reset — elected $2.6M → allowed $2,500,000', () => {
    const r = calc179Limitation({ ...ample, entities: ent(2_600_000), taxYear: 2025 })
    expect(r.sec179Allowed).toBe(2_500_000)
  })

  it('CHAR: SPEC-179D-6 [Rev. Proc. 2023-34]: 2024 — elected $1.3M → allowed $1,220,000', () => {
    const r = calc179Limitation({ ...ample, entities: ent(1_300_000), taxYear: 2024 })
    expect(r.sec179Allowed).toBe(1_220_000)
  })

  it('CHAR: SPEC-179D-7 [regression]: under-cap elections are untouched — the pre-T-3 contract holds exactly', () => {
