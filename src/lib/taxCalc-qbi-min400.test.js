...
describe('§199A(i) $400 minimum — active-participation gate (audit #3)', () => {
  ...
  it('CHAR: passive rental ($1,500 QBI, non-REP) does NOT get the $400 floor', () => {
  ...
  it('CHAR: active sole-prop ($1,500 QBI) DOES get the $400 floor', () => {
  ...
  it('CHAR: REP rental with material participation ($1,500 QBI) gets the $400 floor', () => {
    const r = calcTaxReturn({
  ...
  it('CHAR: passive rental + small active business: active QBI under $1,000 blocks the floor', () => {
    const r = calcTaxReturn({
  ...
  it('CHAR: passive partnership ($1,500 QBI) does NOT get the $400 floor', () => {
    const r = calcTaxReturn({
      ...BASE, w2: 40000,
  ...
  it('CHAR: active partnership ($1,500 QBI) DOES get the $400 floor', () => {
    const r = calcTaxReturn({
      ...BASE, w2: 40000,
  ...
  it('CHAR: calcQBI: passive-only activeQbi below $1,000 yields no floor', () => {
