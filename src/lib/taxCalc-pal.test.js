...
describe('calc469iAllowance — §469(i) special allowance (single source of truth)', () => {
  ...
  it('CHAR: full $25,000 allowance at or below the phase-out start (SPEC: §469(i)(2))', () => {
  ...
  it('CHAR: phases out 50¢ per $1 of MAGI over $100,000 (SPEC: §469(i)(3)(A))', () => {
  ...
  it('CHAR: $0 allowance at or above $150,000 MAGI (SPEC: §469(i)(3)(A))', () => {
  ...
  // at every MAGI level.
  it('CHAR: MFS: $0 allowance regardless of MAGI (SPEC: §469(i)(5)(B))', () => {
  ...
  it('CHAR: non-active participant: $0 allowance (SPEC: §469(i)(6))', () => {
  ...
  it('CHAR: nullish MAGI treated as $0 → full allowance', () => {
...
describe('PAL_* constants — internal consistency (audit F-01 / F-15)', () => {
  ...
  it('CHAR: PAL_PHASE_OUT_END is consistent with START + BASE / RATE (SPEC: §469(i)(3)(A))', () => {
  ...
  it('CHAR: statutory values (SPEC: §469(i)(2), §469(i)(3)(A))', () => {
  ...
  it('CHAR: helper output is derived from the named constants (wiring check)', () => {
...
describe('engine §469(i) parity after centralization (audit F-01)', () => {
  ...
  it('CHAR: phased allowance: $120K AGI, $20K loss → $5K suspended (SPEC: §469(i)(3)(A))', () => {
  ...
  it('CHAR: MFS suspends the entire passive rental loss (SPEC: §469(i)(5)(B))', () => {
  ...
  it('CHAR: non-active participant: full suspension (SPEC: §469(i)(6))', () => {
...
describe('NOL_CARRYFORWARD_CAP_RATE wiring (audit F-02)', () => {
  ...
  it('CHAR: constant holds the statutory 80% rate (SPEC: §172(a)(2))', () => {
  ...
  it('CHAR: engine applies the cap from the named constant', () => {
