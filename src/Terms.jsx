    ...
    <div style={{ minHeight: '100vh', background: '#F8FAFC', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <nav style={{position:'sticky',top:0,zIndex:50,background:'white',borderBottom:'1px solid #e5e7eb',padding:'0 40px',display:'flex',alignItems:'center',height:64}}>
        <a href="/" style={{display:'flex',alignItems:'center',gap:8,textDecoration:'none',marginRight:'auto'}}>
          <div style={{width:32,height:32,background:'#0D1B3E',borderRadius:8,display:'flex',alignItems:'center',justifyContent:'center'}}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 24px' }}>
        ...
        <Section title="2. Not Professional Tax Advice Ã¢ÂÂ Estimation Tool Only">
          <p style={{ marginBottom: 10, padding: '12px 16px', background: '#FEF2F2', borderLeft: '4px solid #DC2626', borderRadius: 6 }}><strong>Ã¢ÂÂ  Important Disclaimer:</strong> TaxStat360 is a tax estimation and planning tool only. It is NOT a licensed tax advisor, CPA, enrolled agent, or law firm. Nothing on this platform constitutes professional tax advice, legal advice, or financial advice of any kind.</p>
        ...
        <Section title="3. Subscriptions and Billing">
          ...
          <p style={{ marginBottom: 10 }}>Ã¢ÂÂ¢ <strong>Monthly plans</strong> are billed on the same date each month and may be cancelled at any time.</p>
          <p style={{ marginBottom: 10 }}>Ã¢ÂÂ¢ <strong>Annual plans</strong> are billed once per year. Cancellations take effect at the end of the billing period Ã¢ÂÂ we do not offer pro-rated refunds for annual plans.</p>
        ...
        <Section title="4. Acceptable Use">
          ...
          <p style={{ marginBottom: 8 }}>Ã¢ÂÂ¢ Use TaxStat360 for any unlawful purpose or to facilitate tax fraud</p>
          <p style={{ marginBottom: 8 }}>Ã¢ÂÂ¢ Attempt to reverse engineer, copy, or resell our platform</p>
          <p style={{ marginBottom: 8 }}>Ã¢ÂÂ¢ Share your account credentials with others outside your organization</p>
          <p>Ã¢ÂÂ¢ Upload false or fabricated financial data</p>
        </Section>
      ...
      <footer style={{ borderTop: '1px solid #E2E8F0', padding: '24px 32px', textAlign: 'center', color: SL, fontSize: 13 }}>
        ÃÂ© 2026 TaxStat360. All rights reserved. ÃÂ· <span onClick={() => nav('/privacy')} style={{ cursor: 'pointer', color: B }}>Privacy Policy</span>
      </footer>
    </div>
  )
}